// 🧠 This script deploys the XOSealsDrop smart contract and pins metadata. It also generates a Vault Pulse preview, pushes to GitHub, and optionally triggers a Discord webhook.
// 🔗 Related to 21xo.exchange or other Web3 deployments.
...
- GitHub Commit: [\`${shortHash}\`](https://github.com/xo-ecosystem/xo-core/commit/${shortHash})
- Tag: \`${tag}\`
`;
...
🏷️ Tag: \`${tag}\`
📦 Contract: \`${contract.target}\`
🔗 GitHub: https://github.com/xo-ecosystem/xo-core/commit/${shortHash}`
      };
