...
@task
def dispatch(
    c, prompt_path=None, persona=None, task_name=None, drop_id=None, goals=None
):
    """
    ...
    if not all([persona, task_name, drop_id]):
        ...
        print(
            "Usage: xo-fab agent.dispatch --persona=vault_keeper --task='publish drop' --drop_id=message_bottle"
        )
        return False
