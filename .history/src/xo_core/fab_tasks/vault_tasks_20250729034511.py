...
try:
    from xo_core.fab_tasks.vault_sign import ns as vault_sign_ns
...
try:
    from xo_core.fab_tasks.vault_explorer_preview import ns as explorer_ns
...
try:
    from xo_core.fab_tasks.vault_pulse_sync import ns as pulse_sync_ns
