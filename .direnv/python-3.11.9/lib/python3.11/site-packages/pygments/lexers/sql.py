...
class PostgresExplainLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (
                r"(hit|read|dirtied|written|write|time|calls)(=)",
                bygroups(Comment.Single, Operator),
            ),
            ...
            (
                ...
                bygroups(Comment.Preproc, Punctuation, Whitespace),
                "object_name",
            ),
            (
                r"(Cache Key|Cache Mode)(:)( )",
                bygroups(Comment, Punctuation, Whitespace),
                "object_name",
            ),
            ...
            # Handle JIT counters
            (
                r"(JIT|Functions|Options|Timing)(:)",
                bygroups(Comment.Preproc, Punctuation),
            ),
            (
                r"(Inlining|Optimization|Expressions|Deforming|Generation|Emission|Total)",
                Keyword.Pseudo,
            ),
...
class GoogleSqlLexer(RegexLexer):
    ...
    def analyse_text(text):
        ...
        return 0.001 * sum(
            count for t, count in tokens.items() if t in googlesql_identifiers
        )
    ...
    tokens = {
        "root": [
            ...
            (
                ...
                r"|TODAY|NOW|TRUE|FALSE|NULL|EXISTS)\b",
                Keyword,
            ),
            (r"[+*/<>=%-]", Operator),
