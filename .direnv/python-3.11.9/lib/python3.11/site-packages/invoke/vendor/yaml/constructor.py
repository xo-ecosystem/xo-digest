    ...
    def check_state_key(self, key):
        ...
        if self.get_state_keys_blacklist_regexp().match(key):
            raise ConstructorError(
                None,
                None,
                "blacklisted key '{}' in instance state found".format(key),
                None,
            )
        ...
        if unsafe:
            try:
                ...
                raise ConstructorError(
                    "while constructing a Python module",
                    mark,
                    "cannot find module {!r} ({})".format(name, exc),
                    mark,
                )
    ...
    def find_python_name(self, name, mark, unsafe=False):
        ...
        if unsafe:
            try:
                ...
                raise ConstructorError(
                    "while constructing a Python object",
                    mark,
                    "cannot find module {!r} ({})".format(module_name, exc),
                    mark,
                )
        ...
        if not hasattr(module, object_name):
            raise ConstructorError(
                "while constructing a Python object",
                mark,
                "cannot find {!r} in the module {!r}".format(object_name, module.__name__),
                mark,
            )
...
class UnsafeConstructor(FullConstructor):
    ...
    def find_python_module(self, name, mark):
        return super().find_python_module(
