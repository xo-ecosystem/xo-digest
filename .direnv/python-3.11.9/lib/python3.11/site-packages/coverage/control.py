...
class Coverage(TConfigurable):
    ...
    def _init(self) -> None:
        ...
        self._debug = DebugControl(
            self.config.debug, self._debug_file, self.config.debug_file
        )
    ...
    def set_option(
        self, option_name: str, value: TConfigValueIn | TConfigSectionIn
    ) -> None:
    ...
    def _analyze(self, morf: TMorf) -> Analysis:
        ...
        return analysis_from_file_reporter(
            data, self.config.precision, file_reporter, filename
        )
    ...
    def sys_info(self) -> Iterable[tuple[str, Any]]:
        ...
        info = [
            ...
            (
                "CTracer",
                f"available from {CTRACER_FILE}" if CTRACER_FILE else "unavailable",
            ),
            ...
            (
                "environment",
                [f"{k} = {v}" for k, v in relevant_environment_display(os.environ)],
            ),
