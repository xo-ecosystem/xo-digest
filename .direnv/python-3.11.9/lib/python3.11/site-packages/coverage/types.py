...
TConfigValueIn = Optional[
    Union[bool, int, float, str, Iterable[str], Mapping[str, Iterable[str]]]
]
TConfigValueOut = Optional[
    Union[bool, int, float, str, list[str], dict[str, list[str]]]
]
...
class TWarnFn(Protocol):
    ...
    def __call__(
        self, msg: str, slug: str | None = None, once: bool = False
    ) -> None: ...
