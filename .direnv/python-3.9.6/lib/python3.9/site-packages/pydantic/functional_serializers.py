...
class PlainSerializer:
    ...
    def __get_pydantic_core_schema__(
        ...
        return_schema = (
            ...
            else handler.generate_schema(return_type)
        )
...
if TYPE_CHECKING:
    ...
    _FieldPlainSerializerT = TypeVar(
        "_FieldPlainSerializerT", bound=FieldPlainSerializer
    )
...
if TYPE_CHECKING:
    ...
    _ModelPlainSerializerT = TypeVar(
        "_ModelPlainSerializerT", bound=ModelPlainSerializer
    )
...
if TYPE_CHECKING:
    SerializeAsAny = Annotated[
        AnyType, ...
    ]  # SerializeAsAny[list[str]] will be treated by type checkers as list[str]
