...
class _DefinitionsRemapping:
    ...
    def from_prioritized_choices(
        ...
        for _iter in range(
            100
        ):  # prevent an infinite loop in the case of a bug, 100 iterations should be enough
            # For every possible remapped DefsRef, collect all schemas that that DefsRef might be used for:
            schemas_for_alternatives: dict[DefsRef, list[JsonSchemaValue]] = (
                defaultdict(list)
            )
...
class GenerateJsonSchema:
    ...
    def __init__(self, by_alias: bool = True, ref_template: str = DEFAULT_REF_TEMPLATE):
        ...
        self._core_defs_invalid_for_json_schema: dict[
            DefsRef, PydanticInvalidForJsonSchema
        ] = {}
    ...
    def build_schema_type_to_method(
        ...
        """
        mapping: dict[
            CoreSchemaOrFieldType, Callable[[CoreSchemaOrField], JsonSchemaValue]
        ] = {}
        core_schema_types: list[CoreSchemaOrFieldType] = list(
            get_literal_values(CoreSchemaOrFieldType)
        )
        ...
        def handler_func(schema_or_field: CoreSchemaOrField) -> JsonSchemaValue:
            ...
            if self.mode == "serialization" and "serialization" in schema_or_field:
                ...
                if (
                    ...
                    json_schema = self.get_flattened_anyof(
                        [{"type": "null"}, json_schema]
                    )
            if json_schema is None:
                if _core_utils.is_core_schema(
                    schema_or_field
                ) or _core_utils.is_core_schema_field(schema_or_field):
                    generate_for_schema_type = self._schema_type_to_method[
                        schema_or_field["type"]
                    ]
    ...
    def int_schema(self, schema: core_schema.IntSchema) -> JsonSchemaValue:
        ...
        self.update_with_validations(
            json_schema, schema, self.ValidationsMapping.numeric
        )
        json_schema = {
            k: v for k, v in json_schema.items() if v not in {math.inf, -math.inf}
        }
        return json_schema
                ...
                "anyOf": [
                    self.float_schema(
                        core_schema.float_schema(
                            ...
                            multiple_of=(
                                None if multiple_of is None else float(multiple_of)
                            ),
    ...
    def str_schema(self, schema: core_schema.StringSchema) -> JsonSchemaValue:
        ...
        self.update_with_validations(
            json_schema, schema, self.ValidationsMapping.string
        )
    ...
    def bytes_schema(self, schema: core_schema.BytesSchema) -> JsonSchemaValue:
        ...
        json_schema = {
            "type": "string",
            "format": (
                "base64url" if self._config.ser_json_bytes == "base64" else "binary"
            ),
        }
    ...
    def literal_schema(self, schema: core_schema.LiteralSchema) -> JsonSchemaValue:
        ...
        """
        expected = [
            to_jsonable_python(v.value if isinstance(v, Enum) else v)
    ...
    def is_instance_schema(
        ...
        return self.handle_invalid_for_json_schema(
            schema, f'core_schema.IsInstanceSchema ({schema["cls"]})'
        )

    def is_subclass_schema(
        self, schema: core_schema.IsSubclassSchema
    ) -> JsonSchemaValue:
    ...
    def list_schema(self, schema: core_schema.ListSchema) -> JsonSchemaValue:
        ...
        items_schema = (
            {}
            if "items_schema" not in schema
            else self.generate_inner(schema["items_schema"])
        )
    ...
    def dict_schema(self, schema: core_schema.DictSchema) -> JsonSchemaValue:
        ...
        keys_schema = (
            self.generate_inner(schema["keys_schema"]).copy()
        ...
        values_schema = (
            self.generate_inner(schema["values_schema"]).copy()
        ...
        self.update_with_validations(
            json_schema, schema, self.ValidationsMapping.object
        )
        return json_schema
    ...
    def function_before_schema(
        ...
        Returns:
            The generated JSON schema.
        """
        if self.mode == "validation" and (
            input_schema := schema.get("json_schema_input_schema")
        ):
    ...
    def _extract_discriminator(
        ...
        if isinstance(schema["discriminator"], list):
            ...
            if len(schema["discriminator"]) == 1 and isinstance(
                schema["discriminator"][0], str
            ):
    ...
    def chain_schema(self, schema: core_schema.ChainSchema) -> JsonSchemaValue:
        ...
        """
        step_index = (
            0 if self.mode == "validation" else -1
    ...
    def json_or_python_schema(
        self, schema: core_schema.JsonOrPythonSchema
    ) -> JsonSchemaValue:
    ...
    def typed_dict_schema(self, schema: core_schema.TypedDictSchema) -> JsonSchemaValue:
        ...
        if self.mode == "serialization":
            named_required_fields.extend(
                self._name_required_computed_fields(schema.get("computed_fields", []))
            )
        cls = schema.get("cls")
    ...
    def _named_required_fields_schema(
        ...
        for name, required, field in named_required_fields:
            ...
            try:
                ...
                continue
            if "title" not in field_json_schema and self.field_title_should_be_set(
                field
            ):
    ...
    def typed_dict_field_schema(
        self, schema: core_schema.TypedDictField
    ) -> JsonSchemaValue:
    ...
    def dataclass_field_schema(
        self, schema: core_schema.DataclassField
    ) -> JsonSchemaValue:
    ...
    def computed_field_schema(
        self, schema: core_schema.ComputedField
    ) -> JsonSchemaValue:
        ...
        * deprecated
        ...
        if (config_title := config.get("title")) is not None:
            ...
            if not isinstance(title, str):
                raise TypeError(
                    f"model_title_generator {model_title_generator} must return str, not {title.__class__}"
                )
        ...
        docstring = (
            None if cls is BaseModel or dataclasses.is_dataclass(cls) else cls.__doc__
        )

        if docstring:
            json_schema.setdefault("description", inspect.cleandoc(docstring))
        elif issubclass(cls, RootModel) and (
            root_description := cls.__pydantic_fields__["root"].description
        ):
    ...
    def model_fields_schema(
        ...
        if extras_schema is not None:
            ...
            schema_to_update["additionalProperties"] = self.generate_inner(
                extras_schema
            )
        return json_schema
    ...
    def field_is_required(
        ...
        if (
            self.mode == "serialization"
            and self._config.json_schema_serialization_defaults_required
        ):
            return not field.get("serialization_exclude")
        else:
    ...
    def dataclass_args_schema(
        self, schema: core_schema.DataclassArgsSchema
    ) -> JsonSchemaValue:
    ...
    def arguments_schema(self, schema: core_schema.ArgumentsSchema) -> JsonSchemaValue:
        ...
        Returns:
            The generated JSON schema.
        """
        prefer_positional = schema.get("metadata", {}).get(
        ...
        if prefer_positional:
            ...
            if positional_possible:
                return self.p_arguments_schema(
                    p_only_arguments + kw_or_p_arguments, var_args_schema
                )

        keyword_possible = not p_only_arguments and not var_args_schema
        if keyword_possible:
            return self.kw_arguments_schema(
                kw_or_p_arguments + kw_only_arguments, var_kwargs_schema
            )
        ...
        for argument in arguments:
            ...
            if (
                (
                    ...
                    and "required" in argument_schema
                )
                or mode
                not in {
                    "var_args",
    ...
    def custom_error_schema(
        self, schema: core_schema.CustomErrorSchema
    ) -> JsonSchemaValue:
    ...
    def definitions_schema(
        ...
        for definition in schema["definitions"]:
            try:
                ...
                self._core_defs_invalid_for_json_schema[
                    self.get_defs_ref((core_ref, self.mode))
                ] = e
                continue
        return self.generate_inner(schema["schema"])
    ...
    def ser_schema(
        ...
        schema: (
            ...
            | core_schema.IncExSeqSerSchema
            | core_schema.IncExDictSerSchema
        ),
    ...
    def field_title_should_be_set(self, schema: CoreSchemaOrField) -> bool:
        ...
        if _core_utils.is_core_schema_field(schema):
            ...
            raise PydanticInvalidForJsonSchema(
                f"Unexpected schema type: schema={schema}"
            )  # pragma: no cover
    ...
    def encode_default(self, dft: Any) -> Any:
        ...
        try:
            ...
            raise pydantic_core.PydanticSerializationError(
                f"Unable to encode default value {dft}"
            )
    ...
    def handle_invalid_for_json_schema(
        ...
        raise PydanticInvalidForJsonSchema(
            f"Cannot generate a JsonSchema for {error_info}"
        )
    ...
    def render_warning_message(
        self, kind: JsonSchemaWarningKind, detail: str
    ) -> str | None:
...
def model_json_schema(
    ...
    assert not isinstance(
        cls.__pydantic_core_schema__, _mock_val_ser.MockCoreSchema
...
def models_json_schema(
    ...
    *,
    ...
    dict[
        tuple[type[BaseModel] | type[PydanticDataclass], JsonSchemaMode],
        JsonSchemaValue,
    ],
    JsonSchemaValue,
]:
    ...
    inputs: list[
        tuple[type[BaseModel] | type[PydanticDataclass], JsonSchemaMode, CoreSchema]
...
_HashableJsonValue: TypeAlias = Union[
    ...
    bool,
    None,
    tuple["_HashableJsonValue", ...],
    tuple[tuple[str, "_HashableJsonValue"], ...],
]
...
class Examples:
    ...
    @overload
    @deprecated(
        "Using a dict for `examples` is deprecated since v2.9 and will be removed in v3.0. Use a list instead."
    )
    def __init__(
        self,
