...
class TestVerifyingKeyFromDer(unittest.TestCase):
    ...
    def test_edwards_from_public_key_recovery_with_digest(self):
        with self.assertRaises(ValueError) as e:
            VerifyingKey.from_public_key_recovery_with_digest(b"", b"", Ed25519)
...
class TestSigningKey(unittest.TestCase):
    ...
    def test_ed25519_from_der_junk_after_priv_key(self):
        ...
        self.assertIn("trailing junk after the encoded private key", str(e.exception))
        ...
        for method_name, vrf_mthd, vrf_data in [
            ...
            verifiers.append(
                pytest.param(
                    ...
                    vrf_mthd,
                    vrf_data,
                    id=f"{method_name}-{modifier}-{sig_format}",
                )
            )
