...
class CurveFp:
    ...
    def __str__(self):
        if self.__h is not None:
            return "CurveFp(p={}, a={}, b={}, h={})".format(
                self.__p,
                self.__a,
                self.__b,
                self.__h,
            )
        return "CurveFp(p={}, a={}, b={})".format(
            self.__p,
            self.__a,
            self.__b,
        )
...
class CurveEdTw:
    ...
    def __str__(self):
        if self.__h is not None:
            return "CurveEdTw(p={}, a={}, d={}, h={})".format(
                self.__p,
                self.__a,
                self.__d,
                self.__h,
            )
        return "CurveEdTw(p={}, a={}, d={})".format(
            self.__p,
            self.__a,
            self.__d,
        )
    ...
    def from_bytes(cls, curve, data, validate_encoding=True, valid_encodings=None):
        ...
        if key_len == raw_encoding_length and "raw" in valid_encodings:
            ...
            raise MalformedPointError(
                ...
                "any of the enabled ({}) encodings of the "
...
class PointJacobi(AbstractPoint):
    ...
    def from_bytes(
        ...
        :rtype: PointJacobi
        """
        coord_x, coord_y = super().from_bytes(
