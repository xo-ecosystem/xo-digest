    ...
    def __init__(self, wrapped, callback=None):
        ...
        if isinstance(wrapped, _FunctionWrapperBase):
            ...
            if wrapped._self_parent is not None:
                super().__init__(weakref.proxy(wrapped._self_parent, _callback))

            else:
                super().__init__(weakref.proxy(wrapped, _callback))
        ...
        try:
            ...
            super().__init__(weakref.proxy(wrapped.__func__, _callback))
