    ...
    def _read_header(self, execute=EX_CONSTRUCT):
        ...
        if b & 0b10000000 == 0:
            ...
            if self._max_ext_len < 1:
                raise ValueError(f"{1} exceeds max_ext_len({self._max_ext_len})")
            self._reserve(2)
            ...
            if self._max_ext_len < 2:
                raise ValueError(f"{2} exceeds max_ext_len({self._max_ext_len})")
            self._reserve(3)
            ...
            if self._max_ext_len < 4:
                raise ValueError(f"{4} exceeds max_ext_len({self._max_ext_len})")
            self._reserve(5)
            ...
            if self._max_ext_len < 8:
                raise ValueError(f"{8} exceeds max_ext_len({self._max_ext_len})")
            self._reserve(9)
            ...
            if self._max_ext_len < 16:
                raise ValueError(f"{16} exceeds max_ext_len({self._max_ext_len})")
            self._reserve(17)
