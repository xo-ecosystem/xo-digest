...
class DssSigScheme:
    def __init__(
        self, key: Union[DsaKey, EccKey], encoding: str, order: int
    ) -> None: ...
...
class FipsDsaSigScheme(DssSigScheme):
    def __init__(
        self, key: DsaKey, encoding: str, order: int, randfunc: Callable
    ) -> None: ...

class FipsEcDsaSigScheme(DssSigScheme):
    def __init__(
        self, key: EccKey, encoding: str, order: int, randfunc: Callable
    ) -> None: ...
