...
def miller_rabin_test(
    candidate: int, iterations: int, randfunc: Optional[Callable[[int], bytes]] = None
) -> PrimeResult: ...
...
def test_probable_prime(
    candidate: int, randfunc: Optional[Callable[[int], bytes]] = None
) -> PrimeResult: ...
def generate_probable_prime(
    *,
    exact_bits: int = ...,
    randfunc: Callable[[int], bytes] = ...,
    prime_filter: Callable[[int], bool] = ...,
) -> int: ...
def generate_probable_safe_prime(
    *, exact_bits: int = ..., randfunc: Callable[[int], bytes] = ...
) -> int: ...
