...
class DerObject:
    ...
    def __init__(
        self,
        asn1Id: Optional[int] = None,
        payload: Optional[bytes] = ...,
        implicit: Optional[int] = None,
        constructed: Optional[bool] = False,
...
class DerBoolean(DerObject):
    ...
    def __init__(
        self,
        value: bool = ...,
        implicit: Optional[Union[int, bytes]] = ...,
        explicit: Optional[Union[int, bytes]] = ...,
    ) -> None: ...
    def encode(self) -> bytes: ...
...
class DerSequence(DerObject):
    def __init__(
        self,
        startSeq: Optional[Sequence[Union[int, DerInteger, DerObject]]] = None,
        implicit: Optional[int] = None,
    ) -> None: ...
    ...
    def decode(
        ...
        der_encoded: bytes,
        strict: bool = ...,
        nr_elements: Optional[int] = None,
        only_ints_expected: Optional[bool] = False,
    ) -> DerSequence: ...

class DerOctetString(DerObject):
    payload: bytes
    def __init__(
        self, value: Optional[bytes] = ..., implicit: Optional[int] = None
    ) -> None: ...
...
class DerSetOf(DerObject):
    def __init__(
        self,
        startSet: Optional[Set[DerSetElement]] = None,
        implicit: Optional[int] = None,
    ) -> None: ...
