...
class EccKey(object):
    curve: str
    def __init__(
        self, *, curve: str = ..., d: int = ..., point: EccPoint = ...
    ) -> None: ...
    ...
    @overload
    def export_key(
        self, *, format: Literal["PEM", "OpenSSH"], **kwargs: Unpack[ExportParams]
    ) -> str: ...
    @overload
    def export_key(
...
def _import_rfc5915_der(
    encoded: bytes, passphrase: Optional[str] = None, curve_oid: Optional[str] = None
) -> EccKey: ...
