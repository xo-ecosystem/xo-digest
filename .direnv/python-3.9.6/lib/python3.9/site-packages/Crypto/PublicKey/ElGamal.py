...
def generate(bits, randfunc):
    ...
    while 1:
        ...
        obj.g = pow(
            Integer.random_range(
                min_inclusive=2, max_exclusive=obj.p, randfunc=randfunc
            ),
            2,
            obj.p,
        )
    ...
    obj.x = Integer.random_range(
        min_inclusive=2, max_exclusive=obj.p - 1, randfunc=randfunc
    )
...
class ElGamalKey:
    ...
    def _decrypt(self, M):
        ...
        r = Integer.random_range(
            min_inclusive=2, max_exclusive=self.p - 1, randfunc=self._randfunc
        )
    ...
    def __eq__(self, other):
        ...
        for comp in self._keydata:
            result = result and (
                getattr(self.key, comp, None) == getattr(other.key, comp, None)
            )
        return result
