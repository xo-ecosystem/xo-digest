...
@overload
def new(
    key: Buffer, mode: Literal[2], iv: Optional[Buffer] = ..., use_aesni: bool = ...
) -> CbcMode: ...
@overload
def new(
    key: Buffer, mode: Literal[2], IV: Optional[Buffer] = ..., use_aesni: bool = ...
...
@overload
def new(
    key: Buffer, mode: Literal[5], iv: Optional[Buffer] = ..., use_aesni: bool = ...
) -> OfbMode: ...
@overload
def new(
    key: Buffer, mode: Literal[5], IV: Optional[Buffer] = ..., use_aesni: bool = ...
...
@overload
def new(
    key: Buffer, mode: Literal[7], iv: Optional[Buffer] = ..., use_aesni: bool = ...
) -> OpenPgpMode: ...
@overload
def new(
    key: Buffer, mode: Literal[7], IV: Optional[Buffer] = ..., use_aesni: bool = ...
...
@overload
def new(
    key: Buffer, mode: Literal[10], nonce: Optional[Buffer] = ..., use_aesni: bool = ...
) -> SivMode: ...
