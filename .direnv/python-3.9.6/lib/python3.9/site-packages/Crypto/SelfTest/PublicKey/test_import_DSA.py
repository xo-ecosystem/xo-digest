...
-----END ENCRYPTED PRIVATE KEY-----"""
    ...
    def testExportKey10(self):
        ...
        key = DSA.construct(tup)
        randfunc = BytesIO(
            unhexlify(b("27A1C66C42AFEECE") + b("D725BF1B6B8239F4"))
        ).read
        encoded = key.export_key(
            "DER", pkcs8=True, passphrase="PWDTEST", randfunc=randfunc
        )
    ...
    def testImportError1(self):
        self.assertRaises(
            ValueError, DSA.importKey, self.der_pkcs8_encrypted, "wrongpwd"
        )
    ...
    def testExportError2(self):
        ...
        key = DSA.construct(tup)
        self.assertRaises(
            ValueError, key.export_key, "DER", pkcs8=False, passphrase="PWDTEST"
        )
