...
class DSATest(unittest.TestCase):
    ...
    def test_construct_4tuple(self):
        ...
        (y, g, p, q) = (
            bytes_to_long(a2b_hex(param)) for param in (self.y, self.g, self.p, self.q)
        )
    ...
    def _check_public_key(self, dsaObj):
        ...
        self.assertEqual(
            dsaObj.public_key() != dsaObj.public_key(), False
        )  # assertFalse
...
class DSADomainTest(unittest.TestCase):
    ...
    def _get_weak_domain(self):
        ...
        while (
            p.size_in_bits() != 1024
            or Primality.test_probable_prime(p) != Primality.PROBABLY_PRIME
        ):
