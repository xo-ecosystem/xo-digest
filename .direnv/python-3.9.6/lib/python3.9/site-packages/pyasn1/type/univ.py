    ...
    def prettyIn(self, value):
        try:
            ...
            try:
                ...
                raise error.PyAsn1Error(f"Can't coerce {value!r} into integer: {exc}")
...
class BitString(base.SimpleAsn1Type):
    ...
    def fromHexString(cls, value, internalFormat=False, prepend=None):
        ...
        try:
            ...
            raise error.PyAsn1Error(f"{cls.__name__}.fromHexString() error: {exc}")
    ...
    def fromBinaryString(cls, value, internalFormat=False, prepend=None):
        ...
        try:
            ...
            raise error.PyAsn1Error(f"{cls.__name__}.fromBinaryString() error: {exc}")
    ...
    def fromOctetString(cls, value, internalFormat=False, prepend=None, padding=0):
        ...
        """
        value = SizedInteger(
            int.from_bytes(bytes(value), "big") >> padding
        ).setBitLength(len(value) * 8 - padding)
...
class RelativeOID(base.SimpleAsn1Type):
    ...
    def prettyIn(self, value):
        ...
        raise error.PyAsn1Error(
            f"Malformed RELATIVE-OID {value} at {self.__class__.__name__}"
        )
