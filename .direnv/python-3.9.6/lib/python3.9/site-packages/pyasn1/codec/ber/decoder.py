        ...
        while index < substrateLen:
            ...
            if subId < 128:
                ...
                while nextSubId >= 128:
                    ...
                    if index >= substrateLen:
                        raise error.SubstrateUnderrunError(
                            f"Short substrate for sub-OID past {reloid}"
                        )
                    nextSubId = chunk[index]
                    index += 1
            ...
            if state is stDecodeValue:
                ...
                if length == -1:  # indef length
                    ...
                    if not substrateFun and bytesRead != length:
                        ...
                        raise PyAsn1Error(
                            "Read %s bytes are more than expected %s."
                            % (bytesRead, length)
                        )
            ...
            def substrateFunWrapper(asn1Object, substrate, length, options=None):
                ...
                try:
                    substrate_gen = origSubstrateFun(
                        asn1Object, substrate, length, options
                    )
                    ...
                    substrate_gen = Decoder._callSubstrateFunV4asV5(
                        origSubstrateFun, asn1Object, substrate, length
                    )
                yield from substrate_gen
