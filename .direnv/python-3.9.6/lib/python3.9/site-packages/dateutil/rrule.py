...
class rrule(rrulebase):
    ...
    def __init__(
        ...
        if byminute is None:
            ...
            if freq == MINUTELY:
                self._byminute = self.__construct_byset(
        ...
        if bysecond is None:
            ...
            if freq == SECONDLY:
                self._bysecond = self.__construct_byset(
        ...
        while True:
            ...
            if freq == YEARLY:
                ...
                for j in range(rep_rate // gcd(interval, rep_rate)):
                    if byminute:
                        nhours, minute = self.__mod_distance(
                            value=minute, byxxx=self._byminute, base=60
                        )
                    else:
                ...
                for j in range(0, rep_rate // gcd(interval, rep_rate)):
                    if bysecond:
                        nminutes, second = self.__mod_distance(
                            value=second, byxxx=self._bysecond, base=60
                        )
                    else:
