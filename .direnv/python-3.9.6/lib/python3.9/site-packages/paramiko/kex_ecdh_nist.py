...
class KexNistp256:
    ...
    def parse_next(self, ptype, m):
        ...
        raise SSHException(f"KexECDH asked to handle packet type {ptype:d}")
    ...
    def _parse_kexecdh_init(self, m):
        ...
        self.Q_C = ec.EllipticCurvePublicKey.from_encoded_point(self.curve, Q_C_bytes)
    ...
    def _parse_kexecdh_reply(self, m):
        ...
        self.Q_S = ec.EllipticCurvePublicKey.from_encoded_point(self.curve, Q_S_bytes)
        sig = m.get_binary()
