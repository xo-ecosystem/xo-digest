...
class BadAuthenticationType(AuthenticationException):
    ...
    def __str__(self):
        return f"{self.explanation}; allowed types: {self.allowed_types!r}"
...
class PartialAuthentication(AuthenticationException):
    ...
    def __str__(self):
        return f"Partial authentication; allowed types: {self.allowed_types!r}"
...
class ChannelException(SSHException):
    ...
    def __str__(self):
        return f"ChannelException({self.code!r}, {self.text!r})"
