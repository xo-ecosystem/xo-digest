...
class SFTPFile(BufferedFile):
    ...
    def chmod(self, mode):
        ...
        """
        self.sftp._log(DEBUG, f"chmod({hexlify(self.handle)}, {mode!r})")
        attr = SFTPAttributes()
        attr.st_mode = mode
    ...
    def chown(self, uid, gid):
        ...
        self.sftp._log(
            DEBUG,
            f"chown({hexlify(self.handle)}, {uid!r}, {gid!r})",
        )
        attr = SFTPAttributes()
    ...
    def utime(self, times):
        ...
        self.sftp._log(DEBUG, f"utime({hexlify(self.handle)}, {times!r})")
        attr = SFTPAttributes()
    ...
    def truncate(self, size):
        ...
        """
        self.sftp._log(DEBUG, f"truncate({hexlify(self.handle)}, {size!r})")
        attr = SFTPAttributes()
        attr.st_size = size
        self.sftp._request(CMD_FSETSTAT, self.handle, attr)
    ...
    def readv(self, chunks, max_concurrent_prefetch_requests=None):
        ...
        """
        self.sftp._log(DEBUG, f"readv({hexlify(self.handle)}, {chunks!r})")
